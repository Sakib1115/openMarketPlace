...
const contractaddress='0xb7974ab852BD6c6c001414B25DD5B8B8a424de86';
...
//         const data = await contract.methods.mint("2").encodeABI()
...
const approve=async()=>{
    try {
        var count = await web3.eth.getTransactionCount("0xd3Ff00D23c84a79B8F521F6707F5BDf2A9a8A3E4");
        console.log("count===>",count);
        const data = await contract.methods.approve("0x58E5431c617136Fc642867Ae68e6F012d5Ed89d9","2").encodeABI()
