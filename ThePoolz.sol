...
contract Pools is Manageable {
    ...
    function addwhitelistedAddresses(address[] _whitelistedAddresses)
    public
    onlyOwnerOrGov
    {
    ...
    function isPoolCertified(uint256 _id) public view returns(bool){
        return pools[_id].BaseData.isCertified;
    }
...
contract PoolsData is Pools {
        ...
        )
    {
        return (
            ...
            pools[_Id].BaseData.isCertified
        );
    }
